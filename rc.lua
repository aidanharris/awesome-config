...
if (file_exists('/sys/class/backlight/gmux_backlight/brightness'))
then
...
if (file_exists('/sys/class/leds/smc::kbd_backlight/brightness'))
then
...
globalkeys = awful.util.table.join(
  ...
  awful.key({ "Mod1" }, "Tab",
       ...
       {description = "switch to next application", group = "alttab"}
   ),
   awful.key({ "Mod1", "Shift"   }, "Tab",
       function ()
          alttab.switch(-1, "Alt_L", "Tab", "ISO_Left_Tab")
       end,
       {description = "switch to previous application", group = "alttab"}
   )
